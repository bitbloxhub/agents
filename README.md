...
- `pi/extensions/` — custom pi extensions for my preferences, distrobox setup, caveman mode, and project-specific EditorConfig context
...
- **caveman** - loads the caveman skill into prompt context and defaults the agent to caveman ultra mode
